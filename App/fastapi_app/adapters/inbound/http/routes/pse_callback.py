...
# Ajusta este import según dónde tengas UserDB ahora
from adapters.outbound.persistence.sqlalchemy.models import UserDB

# DTOs Pydantic (por ahora siguen en models.py)
from models import Account, Wallet, Movement, CustomerSummary
